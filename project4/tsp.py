...
def getCityDistance(cityList, arrayIndex1, arrayIndex2):
    cityDistance = math.sqrt((math.pow((cityList[arrayIndex1][1] - cityList[arrayIndex2][1]), 2)) +
                             (math.pow((cityList[arrayIndex1][2] - cityList[arrayIndex2][2]), 2)))
